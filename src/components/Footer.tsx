                ...
                {section.links.map((link, linkIndex) => (
                  <motion.li key={linkIndex}>
                    <button
                      ...
                      className="text-gray-600 hover:text-[#018136] text-sm transition-colors duration-300 text-left"
                      whileHover={{ x: 5 }}
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <button className="text-gray-600 hover:text-[#018136] transition-colors duration-300">
                Privacy Policy
              </button>
              <button className="text-gray-600 hover:text-[#018136] transition-colors duration-300">
                Terms of Service
