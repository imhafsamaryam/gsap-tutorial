        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              From small businesses to large enterprises, we offer proven ERP
              solutions that streamline operations, improve efficiency, and
              drive growth.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Our ERP products are designed to integrate seamlessly with your
                existing processes, providing comprehensive business management
                capabilities that grow with your organization.
              </p>
            ...
            <div className="relative">
              <div className="bg-white p-8 rounded-3xl shadow-xl">
                <div className="space-y-6">
                  <div className="text-center">
                    <div className="text-3xl font-bold text-[#018136] mb-2">
                      4
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-xl font-bold text-[#018136]">
                        50+
                      </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Comprehensive enterprise-level ERP solution designed for
                    large organizations with complex business requirements and
                    multiple locations.
                  </p>
                  ...
                  <CardContent className="p-0 space-y-6">
                    ...
                    <div className="pt-4 border-t">
                      ...
                      <p className="text-sm text-gray-600">
                        6-12 months for full deployment
                      </p>
                    </div>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="sage200" className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Perfect mid-market ERP solution for growing businesses that
                    need robust functionality without enterprise-level
                    complexity.
                  </p>
            ...
            <TabsContent value="zoho" className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600">
                    Modern cloud-based accounting solution with AI-powered
                    automation, perfect for businesses seeking flexible,
            ...
            <TabsContent value="busy" className="space-y-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div className="space-y-6">
                  ...
                  <p className="text-lg text-gray-600">
                    User-friendly accounting solution designed specifically for
                    small and medium enterprises with industry-specific modules
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Find the perfect fit for your business size and industry
              requirements
            </p>
          </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="bg-gradient-to-r from-[#018136]/5 to-[#FFDF58]/5">
                    <th className="text-left py-6 px-8 font-semibold text-gray-900">
                      Features
                    </th>
                    <th className="text-center py-6 px-8 font-semibold text-gray-900">
                      Sage 300
                    </th>
                    <th className="text-center py-6 px-8 font-semibold text-gray-900">
                      Sage 200
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr>
                    ...
                    <td className="py-4 px-8 text-center text-sm">
                      Large Enterprise
                    </td>
                    <td className="py-4 px-8 text-center text-sm">
                      Mid-Market
      ...
      <section className="py-20 bg-gradient-to-br from-[#018136]/5 via-white to-[#FFDF58]/10">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Let our experts help you select the perfect ERP system for your
            business needs
          </p>
