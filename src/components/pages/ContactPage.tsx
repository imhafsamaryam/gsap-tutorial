      ...
      <section className="py-20 bg-gradient-to-br from-green-50 to-white relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          <div className="text-center">
            <Badge className="bg-[#018136]/10 text-[#018136] px-4 py-2 mb-6">CONTACT US</Badge>
            <h1 className="text-5xl font-bold text-gray-900 mb-6">
              Get Started with Your ERP Transformation
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Ready to transform your business operations? Our ERP experts are here to help you choose 
              the perfect solution and provide ongoing support every step of the way.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600">
                  Fill out the form below and our ERP specialists will contact you within 24 hours 
                  to discuss your requirements and provide a customized solution.
                </p>
              </div>
                ...
                <CardContent className="p-0">
                  ...
                  >
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <Label htmlFor="email" className="text-gray-900 font-medium">Business Email *</Label>
                      <Input 
                        id="email" 
                        type="email" 
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="employees" className="text-gray-900 font-medium">Company Size</Label>
                        <Select>
                          <SelectTrigger className="border-gray-200 focus:border-[#018136] focus:ring-[#018136]">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="service" className="text-gray-900 font-medium">Service Interest</Label>
                      <Select>
                        <SelectTrigger className="border-gray-200 focus:border-[#018136] focus:ring-[#018136]">
                          <SelectValue placeholder="What service are you interested in?" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="sage300">Sage 300 Implementation</SelectItem>
                          <SelectItem value="sage200">Sage 200 Implementation</SelectItem>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="message" className="text-gray-900 font-medium">Project Details</Label>
                      <Textarea 
                        id="message" 
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <Label htmlFor="terms" className="text-sm text-gray-600">
                        I agree to receive communications about ERP solutions and services. 
                ...
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 rounded-full bg-[#018136]/10 flex items-center justify-center flex-shrink-0">
                      <svg className="w-6 h-6 text-[#018136]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <Card className="p-8 hover:shadow-xl transition-shadow">
                <CardContent className="p-0">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="space-y-3">
                      <h3 className="font-semibold text-gray-900">Regional Office</h3>
                      <div className="space-y-1 text-gray-600">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">Sales Email</div>
                      <div className="text-gray-600">sales@erpsolutions.com</div>
          ...
          <CollapsibleFAQ faqs={[
            {
              ...
              answer: "Implementation timelines vary by solution: Busy Accounting (1-3 weeks), Zoho Books (2-4 weeks), Sage 200 (3-6 months), Sage 300 (6-12 months). We provide detailed project timelines during consultation."
            },
            {
              question: "Do you provide training for our team?",
              answer: "Yes, comprehensive training is included with all implementations. We provide on-site training, online sessions, and ongoing support to ensure your team is confident using the new system."
            },
            {
              question: "Can you migrate data from our current system?",
              answer: "Absolutely. We handle data migration from most existing systems including QuickBooks, Excel, legacy ERP systems, and custom databases. We ensure data integrity and provide validation throughout the process."
            },
            {
              question: "What ongoing support do you provide?",
              answer: "We offer 24/7 technical support, regular system updates, ongoing optimization, and annual maintenance contracts. Our support team is always available to help with any issues."
            },
            {
              question: "How much does ERP implementation cost?",
              answer: "Costs vary based on solution complexity, company size, and customization needs. We provide transparent pricing during consultation with no hidden fees. Most implementations pay for themselves within 12-18 months through efficiency gains."
            }
          ]} />
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join hundreds of businesses that have streamlined their operations with our ERP solutions
          </p>
