...
export function HomePage({ onPageChange }: HomePageProps) {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-20 sm:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Streamline operations across departments with our integrated platform. 
                From finance to inventory, CRM to reporting - manage everything from one powerful system.
              </motion.p>
              ...
              >
                ...
                >
                  ...
                  >
                    <motion.div
                      className="absolute inset-0 bg-[#e6c84d] -translate-x-full group-hover:translate-x-0 transition-transform duration-300"
                    />
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
              Comprehensive business management tools designed to scale with your growth
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Integrate finance, inventory, CRM, and HR in a single platform for seamless operations."
              },
              {
                ...
                description: "Tailored solutions designed to fit your specific industry needs and business processes."
              },
              {
                icon: "w-6 h-6 rounded-full bg-[#018136]",
                bgColor: "bg-[#018136]/10",
                ...
                description: "Round-the-clock technical support with continuous system optimization and updates."
              },
              {
                icon: "w-6 h-6 rounded-full bg-[#FFDF58]",
                bgColor: "bg-[#FFDF58]/20",
                ...
                description: "Pre-configured modules for manufacturing, retail, healthcare, and 50+ other industries."
              }
            ].map((feature, index) => (
              <motion.div
                key={index}
              ...
              >
                <Card className={`p-6 hover:shadow-xl transition-all duration-300 group cursor-pointer ${feature.borderColor} h-full`}>
      ...
      {/* Stats Section */}
      <AnimatedSection className="py-20 bg-gradient-to-br from-[#018136]/5 via-white to-[#FFDF58]/10" animation="fadeIn">
        <div className="max-w-6xl mx-auto px-6">
            ...
            {[
              {
                ...
                description: "From manufacturing to healthcare, we've got your industry covered"
              },
              {
                value: 1000,
                suffix: "+",
      ...
      <AnimatedSection className="py-20 bg-white" animation="fadeInUp">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-lg sm:text-xl text-gray-600 max-w-2xl mx-auto">
              Choose from our range of proven ERP solutions, each designed for different business scales and needs
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                badge: { text: "Enterprise", className: "bg-[#018136]/10 text-[#018136]" },
                title: "Sage 300",
                description: "Comprehensive enterprise solution for large organizations with complex requirements."
              },
              {
                badge: { text: "Mid-Market", className: "bg-[#FFDF58]/20 text-gray-800" },
                title: "Sage 200",
                description: "Perfect for growing businesses that need robust functionality without enterprise complexity."
              },
              {
                badge: { text: "Cloud-Based", className: "bg-[#018136]/10 text-[#018136]" },
                title: "Zoho Books",
                description: "Modern cloud accounting solution with AI-powered automation and integrations."
              },
              {
                badge: { text: "SME Focused", className: "bg-[#FFDF58]/20 text-gray-800" },
                title: "Busy Accounting",
                description: "User-friendly solution designed specifically for small and medium enterprises."
              }
            ].map((product, index) => (
              <motion.div
                key={index}
      ...
      {/* CTA Section */}
      <AnimatedSection className="py-20 bg-gradient-to-br from-[#018136]/5 via-white to-[#FFDF58]/10 relative overflow-hidden" animation="zoomIn">
        <motion.div 
        ...
        <div className="relative max-w-6xl mx-auto px-6">
          ...
          >
            ...
            >
              Join thousands of businesses that have streamlined their operations with our ERP solutions.
