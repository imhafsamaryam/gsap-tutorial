...
import { CheckCircle, IndianRupee, FileText, Calculator, Users, BarChart3, Shield, ArrowRight } from "lucide-react";
...
export function BusyAccountingPage({ onPageChange }: BusyAccountingPageProps) {
  const features = [
    { icon: IndianRupee, title: "GST Ready", description: "Complete GST compliance with auto-calculations" },
    { icon: FileText, title: "Invoicing", description: "Professional invoicing with customizable templates" },
    { icon: Calculator, title: "Accounting", description: "Complete double-entry accounting system" },
    { icon: Users, title: "Multi-User", description: "Support for multiple users with role-based access" },
    { icon: BarChart3, title: "Reports", description: "100+ built-in reports for business insights" },
    { icon: Shield, title: "Data Security", description: "Bank-level security for your financial data" }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-white">
      ...
      <section className="relative px-6 py-20 lg:py-32 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#018136]/5 to-orange-500/5" />
            ...
            <AnimatedSection className="space-y-8">
              ...
              >
                ...
                <h1 className="text-4xl lg:text-6xl text-gray-900 mb-6">
                  Busy Accounting
                  <span className="block text-[#018136]">Made Simple</span>
                </h1>
                <p className="text-xl text-gray-600 leading-relaxed">
                  India's most trusted accounting software with comprehensive GST compliance, 
                  inventory management, and business intelligence for all business sizes.
                </p>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <span className="relative z-10 flex items-center">
                    Download Free Trial <ArrowRight className="ml-2 w-5 h-5" />
                  </span>
                </Button>
                <Button 
                  variant="outline"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Busy Accounting provides all the tools you need to manage your business finances efficiently
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                Stay compliant with all GST regulations effortlessly. Busy Accounting handles 
                all GST calculations, returns, and reporting automatically.
              </p>
              ...
              <Card className="relative p-8 bg-white shadow-2xl">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Approved by GST Network (GSTN) for seamless compliance and filing.
                  </p>
      ...
      <AnimatedSection className="px-6 py-20 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Select the version that best fits your business needs. All versions include GST compliance.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {versions.map((version, index) => (
              ...
              >
                ...
                <Card className={`p-8 h-full ${version.popular ? 'ring-2 ring-[#018136] shadow-2xl' : 'shadow-lg'}`}>
                  <div className="text-center mb-8">
                    <h3 className="text-2xl text-gray-900 mb-2">{version.name}</h3>
                    <p className="text-gray-600 mb-4">{version.description}</p>
                    <div className="flex items-baseline justify-center">
                      <span className="text-4xl text-[#018136]">₹{version.price.toLocaleString()}</span>
      ...
      <AnimatedSection className="px-6 py-20 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We provide comprehensive support to ensure you get the most out of Busy Accounting
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: "Installation", description: "Free software installation and setup" },
              { title: "Data Migration", description: "Transfer data from existing systems" },
              { title: "User Training", description: "Comprehensive training for all users" },
              { title: "Ongoing Support", description: "24/7 technical support and assistance" }
            ].map((service, index) => (
              <motion.div
                key={service.title}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                <Card className="p-6 text-center hover:shadow-lg transition-all duration-300">
                  <motion.div
                    ...
                    whileHover={{ scale: 1.1 }}
                  >
                    <span className="text-xl text-[#018136]">{String(index + 1).padStart(2, '0')}</span>
                  </motion.div>
      ...
      {/* CTA Section */}
      <AnimatedSection className="px-6 py-20 bg-gradient-to-br from-[#018136] to-orange-600">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-green-100 mb-8 max-w-2xl mx-auto">
              Join thousands of businesses already using Busy Accounting for efficient financial management.
            </p>
