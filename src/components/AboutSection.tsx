        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-bold text-gray-900 leading-tight">
              <span className="text-[#018136]"> </span> is an expert Odoo partner that blends AI-powered automation, deep industry insights, and seamless integrations to help businesses optimize operations, scale efficiently, and drive digital transformation.
            </h2>
          </div>
