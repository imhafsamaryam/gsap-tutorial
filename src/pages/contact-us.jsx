...
const ContactUsPage = () => {
    ...
    return (
        <div className="min-h-screen rounded-b-4xl bg-slate-950">
            <div className="container mx-auto px-[1rem] md:px-[2rem] pt-[20vh] pb-20">
                <div ref={titleRef} className="text-center mb-16">
                    <GradientSubtitle text={"Contact Us"} />
                    ...
                    <p className="text-lg mt-6 max-w-2xl mx-auto text-gray-400">
                        Have questions about our products or services? Reach out to us and our team will get back to you as soon as
                        possible.
                    </p>
                </div>
                ...
                <div className="flex flex-col lg:flex-row gap-12 my-16">
                    <div ref={formRef} className="w-full lg:w-3/5">
                        <div className="bg-slate-900 rounded-3xl p-8 border border-gray-800">
                            ...
                            {submitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                required
                                                className="w-full bg-slate-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:ring-2 focus:ring-green-500"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    <button
                                        ...
                                        className={`w-full bg-gradient-to-r from-[#3c7321] to-[#1a954b] text-white font-medium py-3 px-6 rounded-lg hover:shadow-lg transition-all duration-300 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
                                    >
                    ...
                    <div ref={infoRef} className="w-full lg:w-2/5">
                        <div className="bg-slate-900 rounded-3xl p-8 border border-gray-800 h-full">
                            <h2 className="text-2xl font-semibold text-white mb-6">Contact Information</h2>

                            <div className="space-y-8">
                                <div className="flex items-start gap-4">
                                    <div className="bg-gradient-to-br from-[#3c7321] to-[#1a954b] p-0.5 rounded-lg">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">Office #304, Al Zarouni Business Centre, Al Barsha 1, Dubai, UAE</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-400">info@ablesoftwaresolutions.com</p>
                                        <p className="text-gray-400">support@ablesoftwaresolutions.com</p>
                                    </div>
                                </div>
                            ...
                            <div className="mt-10">
                                ...
                                <div className="flex gap-4">
                                    <a href="#" className="bg-slate-800 p-3 rounded-full hover:bg-slate-700 transition-colors">
                ...
                <div ref={mapRef} className="my-16">
                    <h2 className="text-2xl font-semibold text-white mb-6">Find Us On The Map</h2>
